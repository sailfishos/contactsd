...
/**
  * Saves telepathy contacts into tracker and keeps them in sync
  */
...
public:
    ...
    void saveAvatarToken(const QString &id, const QString &token,
            const QString &mime);

    // TODO QString contactLocalId to QContactLocalId. Why it is QString?
    void saveToTracker(const QString &contactLocalId,
     ...
     */
    unsigned int contactLocalUID(const CDTpContact * const tpContact,
            bool *existing = 0) const;
